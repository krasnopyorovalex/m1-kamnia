...
{{--                            <li><a href="{{ route('admin.projects.index') }}"><i class="icon-books"></i> <span>Проекты</span></a></li>--}}
                            <li><a href="{{ route('admin.our_services.index') }}"><i class="icon-menu6"></i> <span>Цветовые палитры</span></a></li>
...
{{--                            <li><a href="{{ route('admin.cities.index') }}"><i class="icon-city "></i> <span>Города</span></a></li>--}}
                            <li><a href="{{ route('admin.galleries.index') }}"><i class="icon-stack-picture"></i> <span>Портфолио</span></a></li>
