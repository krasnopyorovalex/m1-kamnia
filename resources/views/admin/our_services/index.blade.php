...
@section('breadcrumb')
    <li class="active">Цветовые палитры</li>
@endsection
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <a href="{{ route('admin.our_service_items.index', $ourService) }}" data-original-title="Цветовые палитры" data-popup="tooltip"><i class="icon-lan2"></i></a>
